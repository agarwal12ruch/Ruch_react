...
export default App
//path will not bound the component, exact path will bound the component but it will not rebound.
// we will solve this error by providing unique key compenent to re render it